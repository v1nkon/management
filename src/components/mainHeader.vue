<template>
    <div class="main-header_container">
		...
		<el-breadcrumb separator="/">
			<el-breadcrumb-item :to="{ path: '/manage' }"><span class="title" style="font-family: '华文隶书';cursor: pointer"><i class="el-icon-menu" style="margin-right:10px;"></i>项目需求管理</span></el-breadcrumb-item>
		</el-breadcrumb>
...
<script>
    ...
    export default {
		...
		methods: {
			...
			...mapMutations(['clearAdminInfo', 'setMenusHasFinished', 'setIsLogOut']),
